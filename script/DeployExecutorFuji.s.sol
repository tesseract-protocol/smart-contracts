...
contract DeployExecutorFuji is Script {
    ...
    function run() external {
        ...
        Executor executor = new Executor(TELEPORTER_REGISTRY, ROUTER, PRIMARY_FEE_TOKEN);

        vm.stopBroadcast();
    }
}

// forge script --chain 43113 script/DeployExecutorFuji.s.sol:DeployExecutorFuji --rpc-url $FUJI_RPC_URL --broadcast -vvvv
